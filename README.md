...
TV Auto 是一款使用 WebView 的轻量级电视直播软件。操作简单，可将网络视频直播资源整理为频道列表，在 Android TV、手机和平板上提供一致的沉浸式播放体验。
